...
export class DirectorsController {
    ...
    @Post("/create")
    @ApiResponse({
        status: 200, description: 'Tạo đạo diễn thành công.', schema: {
            example: {
                success: true,
    ...
    @Put("/Update")
    @ApiResponse({
        status: 200, description: 'Cập nhật thông tin đạo diễn thành công.', schema: {
            example: {
                success: true,
    ...
    @ApiParam({ name: 'id', description: 'ID của đạo diễn', example: 'actorId123' })
    @ApiResponse({
        status: 200, description: 'Xóa bỏ thông tin đạo diễn thành công.', schema: {
            example: {
                success: true,
    ...
    @Get("/all")
    @ApiResponse({
        status: 200, description: 'Lấy toàn bộ thông tin đạo diễn thành công.', schema: {
            example: {
                success: true,
    ...
    @ApiResponse({
        status: 204, description: 'Không có thông tin đạo diễn.', schema: {
            example: {
                success: true,
    ...
    @ApiParam({ name: 'id', description: 'ID của đạo diễn', example: 'actorId123' })
    @ApiResponse({
        status: 200, description: 'Lấy thông tin đạo diễn thành công.', schema: {
            example: {
                success: true,

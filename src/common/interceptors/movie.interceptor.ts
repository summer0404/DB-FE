...
export class MovieInterceptor implements NestInterceptor {
  intercept(
    ...
    if (
      ...
      request?.body?.directors.indexOf("Map ") != -1
    ) {
      let hihi = request.body.directors.replace(/"Map/g, "");
    ...
    if (
      ...
      request?.body?.actors.indexOf("Map ") != -1
    ) {
      let hihi = request.body.actors.replace(/"Map/g, "");
      hihi = hihi.replace(/Map/g, "");
      hihi = hihi.replace(/}"/g, "}");
      hihi = hihi.replace(/\\/g, "");
    ...
    if (
      ...
      request?.body?.genres.indexOf("Map ") != -1
    ) {
      let hihi = request.body.genres.replace(/"Map/g, "");
      hihi = hihi.replace(/Map/g, "");
      hihi = hihi.replace(/}"/g, "}");
      hihi = hihi.replace(/\\/g, "");
